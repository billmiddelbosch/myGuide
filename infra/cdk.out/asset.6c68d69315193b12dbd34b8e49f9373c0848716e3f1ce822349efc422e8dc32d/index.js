...
var smClient = new SecretsManagerClient({});
var cachedOtmApiKey = null;
...
var STOPS_TABLE = process.env.STOPS_TABLE ?? "cityStops";
var STOPS_TABLE_KEY = process.env.STOPS_TABLE_KEY ?? "stopID";
var STOPS_TABLE_SORT_KEY = process.env.STOPS_TABLE_SORT_KEY ?? "stopCity";
var corsHeaders = {
